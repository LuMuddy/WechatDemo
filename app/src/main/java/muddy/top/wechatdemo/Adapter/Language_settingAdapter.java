package muddy.top.wechatdemo.Adapter;
 ...
 * @Describe
 */
public class Language_settingAdapter extends BaseAdapter{
    private List<Language_settingData> mList;
    private Language_settingData data;
    private LayoutInflater inflater;
    private Context mContext;
    public Language_settingAdapter(Context mContext, List<Language_settingData> mList){
